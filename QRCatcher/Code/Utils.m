...
NSString* ScanQRCodeOnScreen() {
    ...
    NSMutableArray* foundQrcodeResults = [NSMutableArray array];
    ...
    for (unsigned int displaysIndex = 0; displaysIndex < dspCount; displaysIndex++)
    {
        ...
        for (CIQRCodeFeature *feature in features) {
            ...
            [foundQrcodeResults addObject:feature.messageString];
        }
    ...
    if (foundQrcodeResults.count > 0) {
        return foundQrcodeResults[0];
    }
